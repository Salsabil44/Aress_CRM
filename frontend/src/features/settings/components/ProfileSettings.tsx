    ...
    <div className="bg-white rounded-xl border border-slate-200/60">
      <div className="px-5 py-4 border-b border-slate-100">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="text-[14px] font-semibold text-slate-800">Profile Information</h3>
            <p className="text-[11px] text-slate-400 mt-0.5">Update your account details</p>
          </div>
        </div>
      </div>

      <form onSubmit={handleSubmit} className="p-5 space-y-4">
        <div className="flex items-center gap-3.5 p-3.5 bg-slate-50 rounded-lg border border-slate-100">
          ...
          <div>
            <p className="text-[14px] font-semibold text-slate-700">{user?.name}</p>
        ...
        {saved && (
          <div className="p-2.5 bg-emerald-50 border border-emerald-100 rounded-lg">
            <p className="text-[12px] text-emerald-600">Profile updated successfully!</p>
          </div>
        )}
        ...
        <div className="space-y-1.5">
          ...
          <input
            ...
            className="w-full rounded-lg border border-slate-200 bg-white px-3.5 py-2 text-[13px] focus:border-primary-300 focus:outline-none focus:ring-2 focus:ring-primary-500/10 hover:border-slate-300 transition-all duration-150"
          />
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <input
            ...
            disabled
            className="w-full rounded-lg border border-slate-200 bg-slate-50 px-3.5 py-2 text-[13px] text-slate-400 cursor-not-allowed"
          />
          <p className="text-[11px] text-slate-300">Contact an admin to change your role</p>
        </div>
